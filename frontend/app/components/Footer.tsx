const Footer = () => {
  return (
    <div className='w-full flex flex-row items-center gap-2 justify-center border-t border-[#464646] p-4 text-[#FFFFFF]'>
      <svg
      ...
      <p className='text-sm'>
        Developed by{' '}
        <a
          href='https://ofoscar.com'
          target='_blank'
          rel='noopener noreferrer'
          className='font-bold text-[#4697C8] hover:text-[#5ba4d1] transition-colors cursor-pointer'
        >
          ofoscar
        </a>
      </p>
